...
public class BorderLightView extends View {
    ...
    private float segmentRatio = 0.2f; // 光段占路径总长度的比例，默认1/8
    ...
    public BorderLightView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BorderLightView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        float dp30 = 100 * getResources().getDisplayMetrics().density;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (pathMeasure != null && pathLength > 0) {
            ...
            updateLightSegment();
            // 绘制流光线段
            canvas.drawLine(startX, startY, endX, endY, lightPaint);
        }
    }
