...
import com.evenbus.myapplication.trace.TraceInvalideActivity;
import com.evenbus.myapplication.trace.TraceLayoutActivity;
...
public class MatrixActivity extends AppCompatActivity {
    ...
    private void traceAnim(){
        // 在按钮点击或其他事件中
        Intent intent = new Intent(MatrixActivity.this, TraceLayoutActivity.class);
    ...
    private void testThreadAnr() {
        ...
        Intent intent = new Intent(MatrixActivity.this, TraceInvalideActivity.class);
        startActivity(intent);
