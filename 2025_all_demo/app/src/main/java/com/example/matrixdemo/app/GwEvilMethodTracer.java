...
public class GwEvilMethodTracer extends Tracer implements ILooperListener {

    private static final String TAG = "Matrix.GwEvilMethodTracer";
    ...
    public GwEvilMethodTracer(TraceConfig config) {
        this.config = config;
        this.evilThresholdMs = config.getEvilThresholdMs();
        this.isEvilMethodTraceEnable = true;
    }
...
//        MatrixLog.e(TAG, "onDispatchBegin");
        indexRecord = AppMethodBeat.getInstance().maskIndex("GwEvilMethodTracer#dispatchBegin");
...
//        AppMethodBeat.o(AppMethodBeat.METHOD_ID_DISPATCH);
    ...
    private static class AnalyseTask implements Runnable {
        ...
        private String printEvil(String scene, int[] processStat, boolean isForeground, StringBuilder stack, long stackSize, String stackKey, long allCost) {
            ...
            print.append(String.format("-\n>>>>>>>>>>>>>>>>>>>>>GwEvilMethodTracer maybe happens Jankiness!(%sms) <<<<<<<<<<<<<<<<<<<<<\n", allCost));
